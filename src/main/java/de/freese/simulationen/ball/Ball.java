...
public class Ball
{
    ...
    /**
     * Liefert die potentielle Energie [J oder Nm].<br>
    ...
    public void move(final double dt)
    {
        ...
        // Bei Rand-Berühung Geschwindigkeit durch Dämpfung verringern.
        if (touchX)
        {
        ...
        // System.out.printf("%f / %f%n", getEKin(), getEPot());
        // System.out.printf("%d / %f%n", getMaxY(), getY());
